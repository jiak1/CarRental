...
<body>
	<div class="h-screen w-screen md:overflow-x-hidden">
		...
		<div id="browsePanel" class="w-fit h-fit pl-8 pr-8 pt-8 ml-auto mr-auto block">
			<h1 class="text-3xl text-black font-bold pt-4 pb-4 text-center">Cart</h1>
			<div class="w-fit max-w-11/12 ml-auto mr-auto overflow-x-auto shadow-md sm:rounded-lg mb-6">
				...
				<br><br>
				<button onclick="clearCart()" class="ml-4 mt-4 px-4 py-2 font-semibold text-sm bg-red-600 hover:bg-red-500 text-white rounded-full shadow-sm float-left">Clear</button>
				<button onclick="checkoutCart()" class="mb-8 mt-4 mr-8 px-4 py-2 font-semibold text-sm bg-main hover:bg-purple-500 text-white rounded-full shadow-sm float-right">Checkout</button>
			</div>
		</div>
